  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-2 right-2 bg-peru-blue text-white px-3 py-1 rounded-full text-xs font-comic font-bold">
          {story.ageRange}
        </div>
      </div>
      
      <CardContent className="p-6">
        <h3 className="text-xl font-title text-peru-blue mb-3 line-clamp-2 leading-tight">
          {story.title}
        </h3>
        
        <div className="flex items-center gap-2 text-peru-green mb-3 bg-peru-green/10 p-2 rounded-lg">
